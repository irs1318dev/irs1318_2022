...
public class ElectronicsConstants
{
    ...
    public static final int CARGO_HOOD_1_FORWARD = 3;
    public static final int CARGO_HOOD_1_REVERSE = 2;
    public static final int CARGO_HOOD_2_FORWARD = 5;
    public static final int CARGO_HOOD_2_REVERSE = 4;
