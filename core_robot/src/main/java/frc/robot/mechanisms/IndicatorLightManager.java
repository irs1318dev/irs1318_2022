...
public class IndicatorLightManager implements IMechanism
{
    ...
    public void update()
    {
        ...
        // if (this.driver.getDigital(DigitalOperation.IndicatorLightA))
        // {
        ...
        // if (this.driver.getDigital(DigitalOperation.IndicatorLightC))
        // {
        ...
        // if (this.driver.getDigital(DigitalOperation.IndicatorLightB))
        // {
