...
public class TuningConstants
{
    ...
    public static final double POWER_OVERCURRENT_SAMPLE_DURATION = TuningConstants.LOOP_DURATION / TuningConstants.POWER_OVERCURRENT_SAMPLES_PER_LOOP;
    public static final int POWER_OVERCURRENT_SAMPLES = (int)(TuningConstants.POWER_OVERCURRENT_TRACKING_DURATION / TuningConstants.POWER_OVERCURRENT_SAMPLE_DURATION); // duration of time to keep track of the average current
